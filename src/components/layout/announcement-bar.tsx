  ...
  return (
    <div className="border-b border-champagne/25 bg-obsidian text-pearl">
      <div className="mx-auto flex max-w-[1440px] items-center justify-center gap-x-4 gap-y-1 px-4 py-2 text-center">
        <span className="hidden shrink-0 items-center rounded-full border border-champagne/40 px-3 py-0.5 font-serif text-[11px] tracking-[0.18em] text-champagne sm:inline-flex">
          {BRAND.name}
        </span>
